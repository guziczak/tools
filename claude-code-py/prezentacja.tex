...
\begin{frame}{Czytanie i~edycja plik\'ow}
    \begin{columns}[T]
        ...
        \terminal{0.95\columnwidth}{claude-code-py}{%
            ...
            \color{white}\textit{Kod pisze noc\k{a} dzielnie.}\\[3pt]
            \color{white}\textit{Gdy commit nagle si\k{e} psuje,}\\
            \color{white}\textit{Mruczy do monitora.}\\
            \color{white}\textit{Refactor robi z~zapa\l{}em,}\\
            \color{white}\textit{I~merge'uje do rana.}%
        }
...
% ══════════════════════════════════════════════════════════════════════════
\begin{frame}{Autonomiczne debugowanie}
    \begin{center}
        \terminal{0.88\textwidth}{claude-code-py}{%
            \color{promptgreen}\textbf{You:} \color{white}Uruchom testy i~napraw te kt\'ore nie przechodz\k{a}\\
            \separator\\[2pt]
            \color{codegray}$\therefore$ Thinking complete (1s, 85 tokens)\\[2pt]
            \toolicon Executing tool:\color{white}bash\\
            \color{codegray}\quad Input: \color{white}pytest tests/ -v\\
            \toolok\color{white}Tool result (success):\\
            \color{codered}\quad FAILED \color{white}tests/test\_auth.py::test\_token\_refresh\\[2pt]
            \toolicon Executing tool:\color{white}read\_file\\
            \toolok\color{white}Tool result (success)\\[2pt]
            \toolicon Executing tool:\color{white}edit\_file\\
            \toolok\color{white}Tool result (success)\\[2pt]
            \toolicon Executing tool:\color{white}bash\\
            \color{codegray}\quad Input: \color{white}pytest tests/test\_auth.py -v\\
            \toolok\color{white}Tool result (success):\\
            \color{codegreen}\quad PASSED \color{white}all tests\\[2pt]
            \color{cyan}\textbf{Claude:} \color{white}Test naprawiony --- mock nie uwzgl\k{e}dnia\l{} nowego parametru.%
        }
    \end{center}
    ...
    \begin{columns}[T]
        \column{0.48\textwidth}
        \begin{itemize}\setlength{\itemsep}{0pt}\footnotesize
            \item Cykl: uruchom $\rightarrow$ przeanalizuj $\rightarrow$ napraw $\rightarrow$ zweryfikuj
            \item Cross-platform: Bash / PowerShell / CMD
        \end{itemize}

        \column{0.48\textwidth}
        \begin{itemize}\setlength{\itemsep}{0pt}\footnotesize
            \item Wiele narzędzi w~jednej rundzie
            \item Automatyczna iteracja do sukcesu
        \end{itemize}
    \end{columns}
\end{frame}
